class MapRunner
{
    public static void main(String[] args)
    {
        ...
        Map map4 = new Map("Europe Travel","Europe","Tourist",1.8,2019,false);
        Map map5 = new Map("Karnataka State Map","India","State",1.1,2021,true);
        Map map6 = new Map("USA Regions","USA","Political",2.5,2016,false);
        Map map7 = new Map("Africa Physical Map","Africa","Physical",1.4,2015,true);
        Map map8 = new Map("City Tourist Map","Singapore","Tourist",1.9,2022,false);
        Map map9 = new Map("Railway Route Map","India","Transport",2.2,2018,true);
        Map map10 = new Map("Old World Map","World","Historical",1.0,2014,false);
